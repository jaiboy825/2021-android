...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into tb_calllog (name,photo,date,phone) values ('김정호','no','휴대전화,2일전','010001')");
        ...
        db.execSQL("insert into tb_calllog (name,photo,date,phone) values ('박범호','no','휴대전화,3일전','010001')");
        db.execSQL("insert into tb_calllog (name,photo,date,phone) values ('추신수','no','휴대전화,4일전','010001')");
